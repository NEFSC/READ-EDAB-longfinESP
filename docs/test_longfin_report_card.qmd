...
\LARGE\centering Longfin Inshore Squid \textit{(Doryteuthis pealeii)} 
\LARGE\centering Ecosystem and Socioeconomic Profile Report Card
...
NEesp2::rpt_card_table(data) |> 
  ...
  flextable::height(i = 5, height = 3, unit = "in")
```
