...
\raggedright
The Mid-Atlantic Fishery Management Council (MAFMC) Ecosystem Approach to Fisheries Management (EAFM) Update [@mafmc_midatlantic_2025] determined that there are moderate-high risks related to:
...
Risk elements are aspects that may threaten achieving the biological, economic, or social objectives to achieving optimal yield that the MAFMC desires from a fishery.
